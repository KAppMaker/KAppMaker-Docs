...
#### If you bought Millionaire Edition: 

SSH:

KMP Mobile app
```
git clone git@github.com:KAppMaker/KAppMakerExtended.git
```
or HTTPS:
```
git clone https://github.com/KAppMaker/KAppMakerExtended.git
```

Web (AI Backend and App Landing Page)
```
git clone git@github.com:KAppMaker/KAppMaker-Web.git
```
or HTTPS:
```
git clone https://github.com/KAppMaker/KAppMaker-Web.git
```
...
first set your own github repository as origin , then merge changes from KAppMaker repository:

```
git remote set-url origin <new-url> (YOUR GITHUB REPO)
git remote add upstream git@github.com:KAppMaker/KAppMaker.git 
// or git remote add upstream git@github.com:KAppMaker/KAppMakerExtended.git
git fetch upstream
